...
export function useDashboardToday(date: string, enabled = true) {
  return useQuery({
    enabled,
...
export function useDashboardAttention(date: string, enabled = true) {
  return useQuery({
    enabled,
...
export function useDashboardOperations(referenceMonth: string, enabled = true) {
  return useQuery({
    enabled,
